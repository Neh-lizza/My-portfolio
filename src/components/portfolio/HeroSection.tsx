    ...
    >
      ...
      <style>{`
        ...
        .iso-social:hover .doodle-hybrid-tooltip {
          opacity: 1; visibility: visible; top: -46px;
        ...
        @media (max-width: 1024px) {
          .arch-frame { max-width: 320px; height: 50vh; border-radius: 180px 180px 0 0; }
        }
        @media (max-width: 640px) {
          .arch-frame { max-width: 260px; height: 42vh; border-radius: 140px 140px 0 0; }
        }
      `}</style>
    </section>
  );
