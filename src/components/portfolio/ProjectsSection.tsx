...
const featuredProjects = [
  {
    ...
    description:
      "Full community + job board platform — auth, real-time messaging, job matching, admin dashboard.",
    ...
    results: "MVP in 8 weeks • 1k+ concurrent users • 0 security incidents",
    link: "#",
    github: "#",
  ...
  },
  {
    ...
    description:
      "Chrome extension with end-to-end encrypted authentication flow, biometric support, and token rotation.",
    tags: ["Chrome APIs", "TypeScript", "Web Crypto", "OAuth 2.0"],
    challenge: "Zero-trust auth in a browser extension context",
    role: "Solo Developer",
    results: "500+ installs • 0 reported vulnerabilities",
    link: "#",
    github: "#",
  ...
  },
  {
    ...
    description:
      "Real-time infrastructure monitoring dashboard with alerting, log aggregation, and deployment tracking.",
    tags: ["React", "Node.js", "WebSocket", "Docker", "PostgreSQL"],
    challenge: "Sub-second latency for real-time metrics at scale",
    role: "Full-Stack Developer",
    results: "99.9% uptime • 50ms avg response time",
    link: "#",
    github: "#",
